...
export default function Hunter() {
  ...
  var hunterpbar = React.createRef();
  ...
  function handlePbar() {
    if (pbar < 55){
      setPbar(pbar+1);
      hunterpbar.current.style.height = pbar * 1.85 + '%';
    }
  }
        ...
        <tr>
          <td rowSpan="5">
            <div className="progress progress-bar-vertical" onClick={handlePbar}>
              <div className="progress-bar bg-success" id="hunterpbar" ref={hunterpbar} role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="55">{pbar}
              </div>
            </div>
          </td>
